    ...
    .then(function(ec)
	  {
	      ...
	      document.getElementById("time_now").innerHTML = `${('0'+ec['now']['hour']).slice(-2)}:${('0'+ec['now']['minute']).slice(-2)}:${('0'+(ec['now']['second']).toFixed(1)).slice(-4)}`
	      ...
	      document.getElementById("countdown_c1").innerHTML = `${ec.countdown_c1.sign}${ec['countdown_c1'].days}d ${('0'+ec['countdown_c1'].hours).slice(-2)}h ${('0'+ec['countdown_c1'].minutes).slice(-2)}m ${('0'+ec['countdown_c1'].seconds.toFixed(1)).slice(-4)}s`
	      document.getElementById("countdown_c2").innerHTML = `${ec.countdown_c2.sign}${ec['countdown_c2'].days}d ${('0'+ec['countdown_c2'].hours).slice(-2)}h ${('0'+ec['countdown_c2'].minutes).slice(-2)}m ${('0'+ec['countdown_c2'].seconds.toFixed(1)).slice(-4)}s`
	      document.getElementById("countdown_mid").innerHTML = `${ec.countdown_mid.sign}${ec['countdown_mid'].days}d ${('0'+ec['countdown_mid'].hours).slice(-2)}h ${('0'+ec['countdown_mid'].minutes).slice(-2)}m ${('0'+ec['countdown_mid'].seconds.toFixed(1)).slice(-4)}s`
	      document.getElementById("countdown_c3").innerHTML = `${ec.countdown_c3.sign}${ec.countdown_c3.days}d ${('0'+ec['countdown_c3'].hours).slice(-2)}h ${('0'+ec['countdown_c3'].minutes).slice(-2)}m ${('0'+ec['countdown_c3'].seconds.toFixed(1)).slice(-4)}s`
	      document.getElementById("countdown_c4").innerHTML = `${ec.countdown_c4.sign}${ec.countdown_c4.days}d ${('0'+ec['countdown_c4'].hours).slice(-2)}h ${('0'+ec['countdown_c4'].minutes).slice(-2)}m ${('0'+ec.countdown_c4.seconds.toFixed(1)).slice(-4)}s`
	  }
	 )
}, 100);
