...
def center_angular_separation(t, p):
    #
...
def t_center(date, p, accuracy_s):
    start = 0
    end = 86400
    step = 60
    ...
    while step >= accuracy_s:
        ...
        l = center_angular_separation(t, p)
...
def t_c1(date, p, r_moon, r_sun, accuracy_s):

    t_max = t_center(date, p, accuracy_s)
...
def t_c4(date, p, r_moon, r_sun, accuracy_s):
...
def t_c3(date, p, r_moon, r_sun, accuracy_s):
...
def t_c2(date, p, r_moon, r_sun, accuracy_s):
...
print(t_c1(date, p, r_moon, r_sun, 1e-5).utc)
print(t_c2(date, p, r_moon, r_sun, 1e-5).utc)
print(t_center(date, p, 1e-4).utc)
print(t_c3(date, p, r_moon, r_sun, 1e-5).utc)
print(t_c4(date, p, r_moon, r_sun, 1e-5).utc)



# plt.grid()
# plt.plot(t.tt, c4_indicator)
# plt.show()
